...
public class NPCManager {
    public void createNPC(Player player, String npcName) {
        ...
        /*
        connection.sendPacket(new PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.EnumPlayerInfoAction.a, yejunho10.magicplugin.npc));
        connection.sendPacket(new PacketPlayOutNamedEntitySpawn(yejunho10.magicplugin.npc));
        */
    }
}